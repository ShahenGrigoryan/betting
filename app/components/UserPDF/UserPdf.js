...
export default function UserPdf(props){
    ...
    return(
        <Box width={"84.5%"} margin={"auto"} style={{background: "#FFFFFF",
            ...
            <iframe width={'100%'} zoom={"scale"} height={"1500px"} src={"http://download.bettingco.ru/public/Betting%20Co.%20%D0%B8%D0%BD%D1%81%D1%82%D1%80%D1%83%D0%BA%D1%86%D0%B8%D1%8F%2009.20.pdf#view=fit"}></iframe>
        </Box>
    )
}
